...
> 当前进度：工程基线、照片同步管线、只读照片 API、媒体路由和 Gallery 视觉基线已经完成。Editorial / Justified 布局、Viewer 与 Docker 部署仍在开发中。
...
默认地址为 `http://localhost:3000`。当前已提供基础照片流，Editorial、Justified 和 Viewer 交互将在后续阶段完成。
