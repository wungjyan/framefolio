...
当前已完成阶段 0–4，即工程基线、照片同步管线、运行时 API、媒体路由、应用视觉基线和 Gallery 布局；下一阶段为 Photo Viewer。
...
- [x] 定义 4–5 组确定性 CSS Grid 排版 pattern。
- [x] 根据照片方向选择可用 pattern，稳定循环而不使用随机布局。
- [x] 在大图、小图、左右位置和垂直错位之间建立节奏。
- [x] 在各种照片数量和横竖比组合下提供安全降级布局。
